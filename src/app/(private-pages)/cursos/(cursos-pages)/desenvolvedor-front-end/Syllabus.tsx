    ...
    >
      ...
      <table className="table-auto">
        ...
        <tbody>
          ...
          <tr>
            <td className="px-4 py-2 border border-black">HTML + CSS / SASS</td>
          ...
          <tr>
            <td className="px-4 py-2 border border-black">JavaScript</td>
          ...
          <tr>
            <td className="px-4 py-2 border border-black">React</td>
            <td className="px-4 py-2 border border-black">1</td>
          ...
          <tr>
            <td className="px-4 py-2 border border-black">Noções de UX/UI</td>
            <td className="px-4 py-2 border border-black">1</td>
            <td className="px-4 py-2 border border-black">3</td>
